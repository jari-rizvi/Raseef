...
class ShopHomePageFragment() : BaseFragment<FragmentShopHomePageBinding, ShopBySlugViewModel>(),
    ...
    lateinit var filterShopArrayList: ArrayList<Doc>
                ...
                Resource.Status.SUCCESS -> {
                    ...
                    it.data?.let {
                        it.let {
                            ...
                            Log.e("productArrayList", it.name)
                ...
                Resource.Status.SUCCESS -> {
                    ...
                    it.data?.let {
                        it.let {
                            ...
                            Log.e("productArrayList2", it.docs[0].categories.get(0).name)

                            productAdapter.notifyDataSetChanged()

                            categoriesArrayList2
